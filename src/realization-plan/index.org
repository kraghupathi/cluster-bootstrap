...
* Milestone Snapshot 
   ...
   |   | no | no | Map |                             |      |        | hrs | hrs |        |
   |---+----+----+-----+-----------------------------+------+--------+-----+-----+--------|
   |   | 1. | 1. |     | [[https://gitlab.com/vlead-systems/cluster-automation/milestones/5][ADS configuration]]           | [[ADS Configuration][ref]]  | Open   |  92 |  87 | [[https://gitlab.com/vlead-systems/cluster-automation/issues?scope=all&utf8=%E2%9C%93&state=opened&milestone_title=Setup%20OpenVZ%20cluster%20automation%20on%20local%20machine][ref]]    |
   |---+----+----+-----+-----------------------------+------+--------+-----+-----+--------|
   |   | 2. | 2. |     | [[https://gitlab.com/vlead-systems/cluster-automation/milestones/6][Automate enabling ADS hooks]] | [[Automate enabling ADS hooks on ADS server][ref]]  | Open   |   0 |   0 |        |
   |---+----+----+-----+-----------------------------+------+--------+-----+-----+--------|
   |   |    |    |     | Total                       |      |        |  92 |  87 |        |
   | ^ |    |    |     |                             |      |        |  et |  87 |        |
   |---+----+----+-----+-----------------------------+------+--------+-----+-----+--------|
...
|---+-------+--------------------------------------------------+--------+----------+--------+------------------+------------------+--------+------------|
|   |   11. | Configure ADS using                              | [[https://gitlab.com/vlead-systems/cluster-automation/issues/23][#23]]    |        8 |     16 | [2017-11-01 Wed] | [2017-11-01 Wed] | Done   | Siva &     |
|   |       | ansible scripts                                  |        |          |        |                  | [2017-11-03 Fri] |        | Raghupathi |
|---+-------+--------------------------------------------------+--------+----------+--------+------------------+------------------+--------+------------|
|   |   12. | Copy public-key of ads server                    | [[https://gitlab.com/vlead-systems/cluster-automation/issues/24][#24]]    |        8 |        | [2017-11-03 Fri] | [2017-11-03 Fri] |        |            |
|   |       | to ansible server's vlead user                   |        |          |        |                  |                  |        |            |
|---+-------+--------------------------------------------------+--------+----------+--------+------------------+------------------+--------+------------|
|   | Total |                                                  |        |       92 |     87 |                  |                  |        |            |
| ^ |       |                                                  |        |      est |    act |                  |                  |        |            |
|---+-------+--------------------------------------------------+--------+----------+--------+------------------+------------------+--------+------------|
...
** Automate enabling ADS hooks on ADS server
  ...
  |   |       |                                |         | hours)   | hours) |                  |        |        |              |
  |---+-------+--------------------------------+---------+----------+--------+------------------+--------+--------+--------------|
  |   | 1.    | Copy public-key of ads server  | [[https://gitlab.com/vlead-systems/cluster-automation/issues/24][#24]]     | 8        |        | [2017-11-07 Tue] |        | TBD    | Siva Shanker |
  |   |       | to ansible server's vlead user |         |          |        |                  |        |        |              |
  |---+-------+--------------------------------+---------+----------+--------+------------------+--------+--------+--------------|
  |   | Total |                                |         | 0        | 0      |                  |        |        |              |
  | ^ |       |                                |         | est      | act    |                  |        |        |              |
