...
|       | machine                                         |        |          |        |            |            |        |            |
|-------+-------------------------------------------------+--------+----------+--------+------------+------------+--------+------------|
|    5. | Update setup-ovpl-centos                        | [[https://gitlab.com/vlead-systems/cluster-automation/issues/20][#20]]    |       24 |     10 | 13-09-2017 | 24-09-2017 | Done   | Raghupathi |
|       | yml files into basemachine-setup.yml on         |        |          |        | 22-09-2017 |            |        |            |
|       | cluster automation                              |        |          |        |            |            |        |            |
|-------+-------------------------------------------------+--------+----------+--------+------------+------------+--------+------------|
|    6. | Adding adding base-machine-setup.yml,           | [[https://gitlab.com/vlead-systems/cluster-automation/issues/20][#20]]    |        5 |      3 | 24-09-2017 | 25-09-2017 | Done   | Raghupathi |
...
|       |                                                 |        |          |        | 25-09-2017 |            |        |            |
|-------+-------------------------------------------------+--------+----------+--------+------------+------------+--------+------------|
|    8. | Deploy a lab on local machin using ads service. | [[https://gitlab.com/vlead-systems/cluster-automation/issues/20][#20]]    |        3 |      8 | 25-09-2017 |            |        |            |
