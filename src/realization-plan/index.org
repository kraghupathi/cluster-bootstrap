...
|    | machine (for ads )                      |        |          |        |            |            |             |            |
|----+-----------------------------------------+--------+----------+--------+------------+------------+-------------+------------|
| 3. | prepare ansible                         | [[https://gitlab.com/vlead-systems/cluster-automation/issues/20][#20]]    |        8 | 4      | 13-09-2017 | 13-09-2017 | Done        | Raghupathi |
|    | configuration file to                   |        |          |        | 14-09-2017 |            |             |            |
|    | install tornado-4.3 on local            |        |          |        |            |            |             |            |
|    | machine                                 |        |          |        |            |            |             |            |
|----+-----------------------------------------+--------+----------+--------+------------+------------+-------------+------------|
| 4. | Update setup-ovpl-centos                | [[https://gitlab.com/vlead-systems/cluster-automation/issues/20][#20]]    |       18 | -      | 13-09-2017 |        --- | In progress | Raghupathi |
