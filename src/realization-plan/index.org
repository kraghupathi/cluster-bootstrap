...
* Milestone Snapshot 
   ...
   |---+----+----+-----+-----------------------------+------+--------+-----+-----+--------|
   |   | 2. | 2. |     | [[https://gitlab.com/vlead-systems/cluster-automation/milestones/6][Automate enabling ADS hooks]] | [[Automate enabling ADS hooks on ADS server][ref]]  | Open   |  25 |  17 |        |
   |---+----+----+-----+-----------------------------+------+--------+-----+-----+--------|
   |   |    |    |     | Total                       |      |        | 109 | 128 |        |
   | ^ |    |    |     |                             |      |        |  et |  at |        |
   |---+----+----+-----+-----------------------------+------+--------+-----+-----+--------|
...
** Automate enabling ADS hooks on ADS server
  ...
  |---+-------+------------------------------------+---------+----------+--------+------------------+------------------+-------------+--------------|
  |   |    4. | Testing 3                          | [[https://gitlab.com/vlead-systems/cluster-automation/issues/26][#26]]     |        2 |        | [2017-11-14 Tue] | [2017-11-14 Tue] | In progress | Siva Shanker |
  |---+-------+------------------------------------+---------+----------+--------+------------------+------------------+-------------+--------------|
  |   |    5. | update steps for adding public-key | [[https://gitlab.com/vlead-systems/cluster-automation/issues/27][#27]]     |        1 |        | [2017-11-14 Tue] |                  |             | Siva Shanker |
  |   |       | on GitLab Systems-model repo       |         |          |        |                  |                  |             |              |
  |---+-------+------------------------------------+---------+----------+--------+------------------+------------------+-------------+--------------|
  |   |    6. | One place to edit variables        | [[https://gitlab.com/vlead-systems/cluster-automation/issues/28][#28]]     |        8 |        | [2017-11-15 Wed] |                  | TBD         | Siva Shanker |
