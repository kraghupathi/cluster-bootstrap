...
* Milestone Snapshot 
   ...
   |---+----+----+-----+-----------------------------+------+--------+-----+-----+--------|
   |   | 2. | 2. |     | [[https://gitlab.com/vlead-systems/cluster-automation/milestones/6][Automate enabling ADS hooks]] | [[Automate enabling ADS hooks on ADS server][ref]]  | Open   |  12 |  10 |        |
   |---+----+----+-----+-----------------------------+------+--------+-----+-----+--------|
   |   |    |    |     | Total                       |      |        |  92 | 121 |        |
   | ^ |    |    |     |                             |      |        |  et |  at |        |
   |---+----+----+-----+-----------------------------+------+--------+-----+-----+--------|
...
** Automate enabling ADS hooks on ADS server
  ...
  |---+-------+---------------------------------+---------+----------+--------+------------------+------------------+-------------+--------------|
  |   | 2.    | Update nameserver in ADS server | [[https://gitlab.com/vlead-systems/cluster-automation/issues/25][#25]]     | 4        |        | [2017-11-13 Mon] | [2017-11-13 Mon] | In Progress | Siva Shanker |
  |   |       |                                 |         |          |        |                  |                  |             |              |
  |---+-------+---------------------------------+---------+----------+--------+------------------+------------------+-------------+--------------|
  |   | Total |                                 |         | 12       | 10     |                  |                  |             |              |
  | ^ |       |                                 |         | est      | act    |                  |                  |             |              |
