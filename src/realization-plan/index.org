...
* Milestone Snapshot 
   ...
   |   | no | no | Map |                   |      |        | hrs | hrs |        |
   |---+----+----+-----+-------------------+------+--------+-----+-----+--------|
   |   | 1. | 1. |     | [[https://gitlab.com/vlead-systems/cluster-automation/milestones/5][ADS configuration]] | [[ADS Configuration][ref]]  | Open   | 84  | 71  | [[https://gitlab.com/vlead-systems/cluster-automation/issues?scope=all&utf8=%E2%9C%93&state=opened&milestone_title=Setup%20OpenVZ%20cluster%20automation%20on%20local%20machine][ref]]    |
   |---+----+----+-----+-------------------+------+--------+-----+-----+--------|
   |   |    |    |     | Total             |      |        | 84  | 71  |        |
   | ^ |    |    |     |                   |      |        | et  | at  |        |
   |---+----+----+-----+-------------------+------+--------+-----+-----+--------|
